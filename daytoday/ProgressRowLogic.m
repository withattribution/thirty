...
//@synthesize row,rowDateSet,intent;
//
...
//{
//    if ([self temporalStatusForRow] == DTProgressRowPast && (![self.rowDateSet containsObject:self.intent.starting] && ![self.rowDateSet containsObject:self.intent.ending]) ) {
